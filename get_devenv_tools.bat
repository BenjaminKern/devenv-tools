...
curl -sL https://github.com/BenjaminKern/devenv-tools/releases/download/v0.0.7/devenv-tools-x86_64-windows.tar.xz -o "%TEMP%\devenv-tools-x86_64-windows.tar.xz"
